...
# note: exclude "rancher" class from count

execute if score "banr" index matches 16.. run scoreboard players set "ban_human" index 0
execute if score "banc" index matches 12.. run scoreboard players set "ban_nitwit" index 0
execute if score "banr" index matches 16.. run scoreboard players set "ban_human" index 15
execute if score "banc" index matches 12.. run scoreboard players set "ban_nitwit" index 11

execute if score "banr" index matches 17.. run scoreboard players set "banc" index 16
execute if score "banc" index matches 13.. run scoreboard players set "banr" index 12
